...
const publicFiles={'/':'index.html','/app.js':'app.js','/session-state.js':'session-state.js','/style.css':'style.css','/content.js':'content.js','/catalog.js':'catalog.js','/location-data.json':'../data/india-locations.json','/location-data-license.txt':'../data/LOCATION-DATA-LICENSE.txt'};
