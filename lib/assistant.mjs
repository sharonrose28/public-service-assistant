...
import {understandIntent,subjects} from './understanding.mjs';
...
export async function answer(raw,options={}){
 const input=validateInput(raw);let info=localUnderstand(input.text),mode='local',warning=false;
